  ...
  return (
    ...
    <Routes>
      <Route path="/" element={<Layout/>}>
        ...
        <Route path="contacts" element={<PrivateRoad><ContactFormik/></PrivateRoad>}/>
        <Route path="register" element={<PublicRoad><SignUp/></PublicRoad>}/>
        <Route path="login" element={<PublicRoad><Login/></PublicRoad> }/>
      </Route>
    </Routes>
